...
import { schemaChangeCode } from "@/app/personal/cambiar-codigo/schema/schemaChangeCode";
import ChangeCodeActions from "@/app/personal/cambiar-codigo/actions/actions-change-code";
...
export function ChangeCodeForm() {
  ...
  const onSubmit = (data: z.infer<typeof schemaChangeCode>) => {
    startTransition(async () => {
      const response = await ChangeCodeActions(data, 5);
      if (response.success) {
