...
**SAGP** es una aplicación full-stack para la gestión integral de personal del Ministerio Del Ministerio del Poder Popular para Relaciones Interiores, Justicia y Paz (MIJP). El sistema permite administrar información de empleados, asignaciones de trabajo, datos familiares, perfil de salud, formación académica, y más.
