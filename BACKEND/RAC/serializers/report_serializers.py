...
from .personal_serializers import EmployeeDetailSerializer, denominacionCargoSerializer, denominacionCargoEspecificoSerializer, TipoNominaSerializer, SexoSerializer
